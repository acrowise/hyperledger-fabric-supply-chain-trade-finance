            ...
            <div className="row">
              <div className="col-6">
                ...
                >
                  <InputGroup
                    disabled
                    value={proof.consignee}
                  />
                </FormGroup>
                <br/>
                {
                  proof.documents && proof.documents.map(i => (
                    <div
                      key={i}
                      style={{
                        display: 'flex',
                    ...
                    >
                      <svg style={{marginRight: 5}} width='15' height='18' viewBox='0 0 15 18' fill='none' xmlns='http://www.w3.org/2000/svg'
